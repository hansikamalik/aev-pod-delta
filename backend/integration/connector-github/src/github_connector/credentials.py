...
from .auth import DEFAULT_API_URL, GitHubAuthConfig

VAULT_PATH_TEMPLATE = "secret/connectors/github/{org_id}"

REQUIRED_FIELDS = ["token", "org"]
...
def load_github_credentials(vault: VaultClientProtocol, org_id: str) -> GitHubAuthConfig:
    ...
    return GitHubAuthConfig(token=secret["token"], org=secret["org"], api_url=api_url)
