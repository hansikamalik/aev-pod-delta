...
Replace this stub with the real import from the shared Connector SDK
package once available, e.g.:
...
wiring to the shared package. Method signatures mirror the six-method
Connector ABC used across the other connectors in this codebase.
"""
...
class Connector(ABC):
    ...
    def push(self, assets: List[Asset]) -> SyncResult:
        """Send normalized records to the platform's asset/exposure service."""
        raise NotImplementedError
